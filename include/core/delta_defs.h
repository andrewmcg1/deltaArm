...
#define BASE_SIDE_LEN 130.0
#define END_EFF_SIDE_LEN 50.0
#define TOP_LINK_LEN 314.325
#define BOT_LINK_LEN 377.825


/**
 * @brief All defines after this point are parameters that are currently unused
 * 
 */
